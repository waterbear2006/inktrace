...
from backend.api import routes_library, routes_notes, routes_chat, routes_deepwork, routes_tencent_doc, routes_upload, routes_search, routes_weread, routes_review, routes_community
...
app.include_router(routes_weread.router)
