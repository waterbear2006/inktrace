...
class SaveSessionRequest(BaseModel):
    ...
    volume_selections: Optional[Dict[str, Any]] = None
    volume_blocks: Optional[List[Dict[str, Any]]] = None
...
async def save_session(request: SaveSessionRequest):
    try:
        ...
        session_data = {
            ...
            "volume_selections": request.volume_selections,
            "volume_blocks": request.volume_blocks,
        ...
        if session:
            return SessionResponse(
                ...
                data={
                    ...
                    "volume_selections": session.get("volume_selections"),
                    "volume_blocks": session.get("volume_blocks")
                }
            )
        else:
            return SessionResponse(
