...
export const DATA_SOURCES = [
  { id: 'wechat', name: '微信读书', status: '已连接', icon: 'Book', enabled: true },
  { id: 'apple', name: 'Apple Books', status: '即将支持', icon: 'BookOpen', enabled: false },
  { id: 'kindle', name: 'Kindle', status: '即将支持', icon: 'Tablet', enabled: false }
];
